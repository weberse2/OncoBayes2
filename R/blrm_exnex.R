...
#' @details
#'
#' `blrm_exnex` is a flexible function for Bayesian meta-analytic
...
#' \itemize{
#'
#' \item *EX (Full exchangeability):* One can assume the
...
#'
#' \item *Differential discounting:* For one or more of the groups \eqn{j=1,\ldots,J},
...
#' \eqn{j = 1,\ldots,J} to *strata* through \eqn{s_j \in \{1,\ldots,S\}},
...
#'
#'
#' \item *EXNEX (Partial exchangeability):* Another mechansim for increasing
