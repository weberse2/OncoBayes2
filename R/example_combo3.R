...
#' `Combo` study and the historical studies, a stratification (through `stratum_id`)
...
#' to strata \eqn{s(j)} as described above. For stratum \eqn{s=1} (`BID`,
#' which contains only the group \eqn{j = 1} (`Combo`)), the standard
...
#' Whereas in stratum \eqn{s=2} (`QD`, which contains the historical groups
#' \eqn{j=2,3} (`HistData1`, `HistData2`)), the standard deviations are
