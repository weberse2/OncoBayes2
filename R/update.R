...
#' @param add_data additional data added to analysis data of `object`
#' @param ... passed to default `update` command
#'
#' The data in `add_data` will be combined with data in
#' `object` using `bind_rows`. The indices for groups and
#' stratums (if defined) are matched between `add_data` and the
#' data of the analysis `object`.
#'
...
#' * Sets the prior of a [blrm_trial()] object (... argument will be
#'   passed to blrm_exnex)
#'
#' @param object blrm_trial object
#' @param ... passed to default `update` command of `blrm_exnex`
#'
#' @template start-example
#' @examples
#'
