...
if (FALSE) {
  ...
  test_that(
    "blrm_exnex example runs",
    example(blrm_exnex, package = "OncoBayes2", run.dontrun = TRUE)
  )
  test_that(
    "prior_summary example runs",
    example(prior_summary.blrmfit, package = "OncoBayes2", run.dontrun = TRUE)
  )
  test_that(
    "posterior_linpred example runs",
    example(
  ...
  test_that(
    "posterior_predict example runs",
    example(
  ...
  test_that(
    "posterior_interval example runs",
    example(
  ...
  test_that(
    "predictive_interval example runs",
    example(
